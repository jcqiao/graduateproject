    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/electronic/manage/admin_donewsadd" method="post" id="myform" name="myform" >
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="introduce" size="50" value="" type="text">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>竞赛公告：</th>
                                <td>
                                    <input class="common-text required" id="title" name="bulletin" size="50" value="" type="text">
                                </td>
                            </tr>
                             <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="info" size="50" value="" type="text">
                                </td>
                            </tr>
                           <tr>
