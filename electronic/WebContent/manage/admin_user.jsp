    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/electronic/manage/admin_douserselect" method="get">
        ...
        <div class="result-wrap">
            <form action="/electronic/manage/admin_douserdel" id="myform" method="post">
	                        ...
	                        <!-- 将数据库元素取出到页面 从用户实体中拿 -->
	                            ...
	                            <!-- 这样点击修改就跳到ToUserUpdate servlet中 -->
	                              ...
	                              <%--  <c:if test="${u.USER_STATUS == 1 }"> --%>
	                                <a class="link-del" href="javascript:Delete('你确定要删除${u.USER_NAME}吗?','/electronic/manage/admin_douserdel?id=${u.USER_ID }&cpage=${cpage }')">删除</a>
	                            	<%-- </c:if> --%>
	                            </td>
	                        </tr>
              		</c:forEach>
