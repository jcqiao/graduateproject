    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/electronic/manage/admin_donewsinfoselect" method="get">
        ...
        <div class="result-wrap">
            <form action="/electronic/manage/admin_donewsinfodel"  id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin_news_infoadd.jsp"><i class="icon-font"></i>新增新闻</a>
                       ...
                       <c:forEach var="n" items="${newslist}">
	                        ...
	                        <!-- 将数据库元素取出到页面 从用户实体中拿 -->
	                            ...
	                            <td ><div >  ${n.NEWS_ID}</div> </td>
	                             <td    style=" width: 70%;" > <div >  ${n.NEWS_INFO }</div></td> 
	                            ...
	                            <td >
	                            <div >
	                                <a class="link-update" href="admin_tonewsinfoupdate?id=${n.NEWS_ID }&cpage=${cpage}">修改</a>
	                                <a class="link-del" href="javascript:Delete('你确定要删除${n.NEWS_ID}吗?','/electronic/manage/admin_donewsinfodel?id=${n.NEWS_ID }&cpage=${cpage }')">删除</a>
	                            </div>
	                            </td>
	                        </tr>
              		</c:forEach>
