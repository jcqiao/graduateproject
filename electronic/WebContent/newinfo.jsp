...
<div style="width:80%;margin-left:200px;position:relative;">
	...
	<c:forEach var="n" items="${newslist}">
		<div style="margin-bottom:30px;  ">
			...
			<span class="specspan" style="display:inline-block; width:400px;height:45px; overflow:hidden;"> ${n.NEWS_INFO }</span>
			<!-- </div> -->
			<div class="diva" style="display: inline-block;position:absolute;right:0;"><a class="btn btn-primary" role="button" href="admin_tonewslookinfo?id=${n.NEWS_ID }">${n.NEWS_TIME }查看</a></div>
...
<script type="text/javascript">$(function () {
	...
	<c:forEach var="n" items="${newslist}">
		...
		<td><a class="link-update" href="admin_tonewslookinfo?id=${n.NEWS_ID }">查看</a></td><br/>
	</c:forEach>
	 --%>
</body>
</html>