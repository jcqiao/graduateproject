...
<div style="width:80%;margin-left:200px;position:relative;">
	...
	<c:forEach var="n" items="${newslist}">
		<div style="margin-bottom:30px;  ">
			...
			<!-- </div> -->
			<div class="diva" style="display: inline-block;position:absolute;right:0;"><a class="btn btn-primary" role="button" href="admin_tonewslook?id=${n.NEWS_ID }">${n.NEWS_TIME }查看</a></div>
